...
public class FrozenStormModel<T extends FrozenStormEntity> extends SinglePartEntityModel<T> {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        modelPartData.addChild("spike2", ModelPartBuilder.create().uv(12, 45).cuboid(-16.0F, -32.0F, -1.0F, 6.0F, 8.0F, 0.0F, dilation), ModelTransform.of(7.0F, 24.0F, 0.0F, 0.0F, 0.0F, -0.1309F));

        modelPartData.addChild("spike1", ModelPartBuilder.create().uv(18, 34).cuboid(-4.0F, -42.0F, -1.0F, 8.0F, 11.0F, 0.0F, dilation), ModelTransform.of(4.0F, 24.0F, 0.0F, 0.0F, 0.0F, -0.1309F));

        modelPartData.addChild("spike3", ModelPartBuilder.create().uv(0, 44).cuboid(6.0F, -27.0F, -2.0F, 6.0F, 12.0F, 0.0F, dilation), ModelTransform.of(-3.0F, 17.0F, 0.0F, 0.0F, 0.0F, 0.2182F));

        modelPartData.addChild("shoulders", ModelPartBuilder.create().uv(0, 16).cuboid(-10.0F, 3.9F, -0.5F, 20.0F, 3.0F, 3.0F, dilation).uv(0, 34).cuboid(-3.0F, -2.0F, -0.51F, 6.0F, 7.0F, 3.0F, dilation), ModelTransform.NONE);
        float f = 0.20420352F;
        ...
        modelPartData.addChild("center_head", ModelPartBuilder.create().uv(0, 0).cuboid(-4.0F, -10.0F, -4.0F, 8.0F, 8.0F, 8.0F, dilation), ModelTransform.NONE);
